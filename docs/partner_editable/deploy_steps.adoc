...
[cols="60,40a"]
|===
^|https://fwd.aws/VWe4j[Deploy {partner-product-name} into a new VPC on AWS^] 
^|link:=../../templates/xl-devops-platform-master.template.yaml[View template^]
^|https://fwd.aws/YEGRk[Deploy {partner-product-name} into an existing VPC on AWS^] 
^|link:=../../templates/xl-devops-platform.template.yaml[View template^]
|===
